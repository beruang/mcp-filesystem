...
pub fn tool_registry() -> Vec<(crate::server::ToolDef, ToolFn)> {
    vec![
        (
            list_allowed_directories::definition(),
            list_allowed_directories::execute as ToolFn,
        ),
        (
            read_text_file::definition(),
            read_text_file::execute as ToolFn,
        ),
        (
            read_media_file::definition(),
            read_media_file::execute as ToolFn,
        ),
        (
            read_multiple_files::definition(),
            read_multiple_files::execute as ToolFn,
        ),
        ...
        (
            ...
            create_directory::execute as ToolFn,
        ),
        (
            list_directory::definition(),
            list_directory::execute as ToolFn,
        ),
        (
            list_directory_with_sizes::definition(),
            list_directory_with_sizes::execute as ToolFn,
        ),
        (
            directory_tree::definition(),
            directory_tree::execute as ToolFn,
        ),
        ...
        (
            ...
            get_file_info::execute as ToolFn,
        ),
    ]
}
